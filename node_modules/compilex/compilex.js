...
var pugoferModule = require('./pugoferModule.js');
...
exports.compilePugofer = function ( envData ,  code , fn ){
	if(exports.stats)
		pyModule.stats = true;
	pyModule.compilePugofer(envData , code , fn );
}

exports.compilePugoferWithInput = function( envData , code , input ,  fn){
	if(exports.stats)
		pyModule.stats = true;
	pyModule.compilePugoferWithInput(envData , code , input , fn );

}

// END OF NEW		END OF NEW		END OF NEW		END OF NEW		END OF NEW 
